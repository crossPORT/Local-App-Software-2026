...
import { wirePortFromIndex } from './port';
import { makeInstanceId, type SessionMessage } from './session_types';
...
export function buildAnnounceNote(
  ...
  return `port=${wirePortFromIndex(leg)};receive=${receiveStatus};instance=${instanceId}`;
}
